...
//     setPayrolls([...payrolls, { id: Date.now(), ...payroll }]);
//   };
...
//       <PayrollForm addPayroll={addPayroll} editingPayroll={editingPayroll} updatePayroll={updatePayroll} />
//       <PayrollTable payrolls={payrolls} deletePayroll={deletePayroll} editPayroll={editPayroll} />
//       <PayrollReport payrolls={payrolls} />
//     </div>
//     </section>
//     </>
//   );
...
//     navigate(`/payroll/${row.employeeName}`, { state: { row } });
//   };
...
//     try {
//       const netPay = parseFloat(formData.salary) - parseFloat(formData.deductions);
//       const currentTimestamp = new Date();

//       if (isEdit) {
//         const payrollRef = doc(db, 'Payroll', editId);
...
//           row.id === editId ? { ...row, ...formData, netPay: netPay.toFixed(2), updatedAt: currentTimestamp } : row
//         ));
//       } else {
...
//         setRows([{ id: docRef.id, ...formData, netPay: netPay.toFixed(2), createdAt: currentTimestamp, updatedAt: currentTimestamp }, ...rows]);
//       }
...
//     [row.employeeName, row.salary, row.payPeriodStart, row.deductions].some((value) =>
